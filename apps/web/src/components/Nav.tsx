...
import { Bot, GraduationCap, Heart, Leaf, LineChart, Menu, Users, X } from "lucide-react";
		...
		<header className="pointer-events-none fixed inset-x-0 top-4 z-50 flex justify-center px-3 sm:px-4">
			...
			>
				...
				<div className="flex shrink-0 items-center gap-2 sm:gap-3">
					...
					<button
						type="button"
						className="flex items-center justify-center rounded-lg p-1.5 text-ink/70 hover:bg-white/50 hover:text-ink md:hidden"
			...
			{isOpen && (
				<div className="pointer-events-auto absolute inset-x-3 top-[calc(100%+0.5rem)] mx-auto max-w-5xl rounded-2xl border border-ink/[0.08] bg-paper/95 p-3 shadow-xl backdrop-blur-3xl sm:inset-x-4 md:hidden">
