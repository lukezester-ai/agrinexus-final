...
export const STR_EN = {
	...
	navCropProfit: 'Crop margin calculator',
	navCropProfitShort: 'Margin',
	...
	weatherDownloadPdf: 'Download PDF',
	weatherOblastLabel: 'Oblast centre',
	weatherOpenFieldWatch: 'Open Field Watch map',
	...
	weatherWind: 'Wind',
	weatherPrecipHour: 'Rain (this hour)',
	weatherPressure: 'Pressure',
	weatherSky: 'Sky',
	weatherSourceNote:
		'Data: Open-Meteo (no API key). For spraying and irrigation decisions, always cross-check official warnings and local forecasts.',
	weatherSevenDay: '7-day outlook',
	weatherDayCol: 'Day',
	weatherMinMax: 'Min–max °C',
	weatherRainCol: 'Rain sum',
	weatherPopCol: 'Rain chance',
	weatherWindMaxCol: 'Wind (max)',
	weatherFinanceHeading: 'Financial effect (your estimates)',
	weatherFinanceSavedLabel: 'Saved resource / avoided spend',
	...
	portalFarmSubCommand: 'Your plan — deadlines',
	...
	registerSubtitle: 'Email and password — one account for AgriNexus and Fieldlot.',
	...
	registerSignupOk: 'Account created — you are signed in.',
	registerConfirmEmail: 'Check your email to confirm, then sign in.',
	phonePh: 'Phone (optional, e.g. +359881234567)',
	agreeUpdates: 'I agree to receive product updates and trade alerts by email.',
	createMyAccount: 'Create account',
	alreadyHaveAccount: 'Already have account',
	loginTitle: 'Sign In',
	loginSubtitle: 'Use the email and password from registration.',
	loginEmailPh: 'Email',
	loginPasswordPh: 'Password',
	loginPasswordHint: 'At least 6 characters.',
	loginSubmit: 'Sign in',
	loginNoAccount: 'No account? Register',
	loginLoading: 'Checking session…',
	loginSignedIn: 'Signed in as',
	...
	clientMarketFocus: 'Trade & corridor focus',
	...
	cropProfitTitle: 'Crop margin (per decare)',
	cropProfitSubtitle:
		'Area, yield, price and costs — indicative margin per decare for trading and Fieldlot listings.',
	cropProfitPreset: 'Quick preset',
	cropProfitPresetWheat: 'Wheat',
	cropProfitPresetSunflower: 'Sunflower',
	cropProfitPresetCorn: 'Maize',
	cropProfitPresetBarley: 'Barley',
	cropProfitPresetCustom: 'Custom',
	cropProfitDecares: 'Decares (area)',
	cropProfitDecaresHint: '10 decares = 1 hectare',
	cropProfitYield: 'Yield (kg per decare)',
	cropProfitPrice: 'Sale price (BGN per tonne)',
	cropProfitCostDka: 'Variable costs (BGN per decare)',
	cropProfitFixed: 'Fixed costs (BGN total, optional)',
	cropProfitFixedHint: 'Machinery lease, irrigation, storage — whole field',
	cropProfitMarginDecare: 'Margin per decare',
	cropProfitMarginTotal: 'Total margin',
	cropProfitMarginHa: 'Margin per hectare',
	cropProfitRevenue: 'Gross revenue',
	cropProfitCosts: 'Total costs',
	cropProfitYieldTotal: 'Total yield',
	cropProfitBreakEvenYield: 'Break-even yield',
	cropProfitBreakEvenPrice: 'Break-even price',
	cropProfitBgn: 'BGN',
	cropProfitBgnPerDecare: 'BGN/decare',
	cropProfitBgnPerHa: 'BGN/ha',
	cropProfitBgnPerT: 'BGN/t',
	cropProfitTonnes: 't',
	cropProfitKgPerDecare: 'kg/decare',
	cropProfitCopy: 'Copy summary',
	cropProfitCopied: 'Copied',
	cropProfitFillFields: 'Fill in valid numbers to see the margin.',
	cropProfitDisclaimer:
		'Indicative only — real margin depends on quality, logistics, contracts and campaign. Not trading or legal advice.',
	cropProfitGoFieldlot: 'Fieldlot listings',
	cropProfitErrDecaresMin: 'Enter at least 0.5 decares.',
	cropProfitErrDecaresMax: 'Area too large for this tool.',
	cropProfitErrYield: 'Enter a positive yield (kg/decare).',
	cropProfitErrPrice: 'Enter a positive price (BGN/t).',
	cropProfitErrCost: 'Costs cannot be negative.',
	...
	commandCompactTitle: 'Deadlines',
	commandCompactSub: 'Next indicative DAFS dates; open full screen for details.',
	...
	commandSectionProfile: 'Profile (farm)',
	...
	opsLinkMarket: 'Modules overview',
	...
	opsPinsEmpty: 'No pins yet — optional saves from the workspace.',
	opsStatTasks: 'Tasks',
	opsStatPins: 'Pins',
