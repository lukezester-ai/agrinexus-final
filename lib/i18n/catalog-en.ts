...
export const STR_EN = {
	...
	marketWatchSubtitle:
		'Latest delayed references plus rolling statistics persisted by the server. AI grouping and outlook appear when MARKET_WATCH_PERSIST and optional LLM insights are enabled.',
	marketWatchRefresh: 'Refresh',
	marketWatchLoading: 'Loading market watch…',
	marketWatchBackMarket: 'Back to marketplace',
	marketWatchQuotesTitle: 'Latest quotes',
	marketWatchTrackedTitle: 'Rolling statistics',
	marketWatchModelsTitle: 'Market clusters',
	marketWatchInsightsTitle: 'Summary & outlook',
	marketWatchEmptyTracked:
		'No tracked history yet. Set MARKET_WATCH_PERSIST=1 on the API, wait for snapshot intervals, then refresh.',
	marketWatchNoModels: 'No cluster model yet.',
	marketWatchNoInsights: 'No AI summary yet.',
	marketWatchSamples: 'samples',
	marketWatchInsightsLangNote: 'AI text below is in Bulgarian.',
	marketWatchDemoMode: 'Market quotes are in demo mode — watch statistics may be empty.',
	marketWatchUpdated: 'Updated',
	marketWatchRefreshingShort: 'Refreshing…',
	marketWatchSnapshotsRecent: 'Recent snapshots (UTC)',
